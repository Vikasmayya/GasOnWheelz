...
const Booking = () => {
  ...
  if (data.quantity-data.empty===0 && price * data.quantity-data.amountr===0){
    ...
    const code = data.otp;
        window["confirmationResult"].confirm(code).then((result) => {
          ...
          firestore.collection("Sales").doc().set({
            ...
            pending_empty:Number(data.quantity-data.empty),
            empty:Number(data.empty),
            order_status: data.order_status,
            order_type: order_type,
            booked_on : serverTimestamp(),
            booked_by : retrievedname,
          })      
          .then(() =>{
    ...
    return (
        <>
         <div style={{backgroundColor:"white", borderRadius:"0.75rem", width:"90%"}} className="container py-4 mt-5">
            <div className=" mb-4">
                <h3 className="text-center fw-bold">Customer's Refill Booking Page</h3>
            </div>
                ...
                <div className="row">
                  <div className="col-md-6 col-10 mx-auto">
                      <form onSubmit={onSignInSubmit}>
                        ...
                        <input type="number" className="form-control round" id="exampleFormControlInput1" name="pending_empty" value={data.quantity-data.empty} onChange={InputEvent} placeholder="Enter the Amount" style={{fontSize:'1.125rem'}} disabled/>
                        </div>
                        <div className="mb-3">
                        ...
                        <input style={{backgroundColor:"#F6FAFD", fontSize:'1.125rem'}} type="number" className="form-control round" id="exampleFormControlInput1" name="amountr" value={data.amountr} onChange={InputEvent} placeholder="Enter the Amount Recieved by the customer" required/>
                        </div> 
                        <div className="mb-3">
                      ...
                      <Modal
                          ...
                          <form onSubmit={onSubmitOTP}>
                              ...
                              <input style={{backgroundColor:"#F6FAFD", fontSize:'1.125rem'}} type="text" className="form-control round" id="exampleFormControlInput1" name="otp" value={data.otp} onChange={InputEvent} placeholder="Enter OTP Number" pattern="[0-9]{6}" required/>
                              </div> 
                              <div className="col-12">
